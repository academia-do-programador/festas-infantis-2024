...
namespace FestasInfantis.WinApp.ModuloTema
{
    internal class ControladorTema : ControladorBase
    {
        ...
        public override void Editar()
        {
            ...
            List<Item> itensDisponiveis = repositorioItem.SelecionarItensDisponiveisParaTema(temaSelecionado);
            ...
            repositorioTema.AtualizarItens(temaSelecionado, telaTema.ItensDesmarcados, telaTema.ItensMarcados);
